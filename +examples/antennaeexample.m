...
%     antennae.orthofunction(pattern1, frames, @specfun.cart2circ, 1) ...
%     antennae.orthofunction(pattern2, frames, @specfun.cart2circ, 1) ...
%     }, ...
%     1 : 2);
...
% gainpatterns = antennae.dispatch({ ...
%     antennae.orthofunction(pattern1, frames, @specfun.cart2sphi, 2) ...
%     antennae.orthofunction(pattern2, frames, @specfun.cart2sphi, 2) ...
%     }, ...
%     facetofunction);
