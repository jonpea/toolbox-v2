...
if nummobiles == 2
    ...
    best_SIR_dB = mean(powerbalance.uplinksir(pathgain, txpowerofmobile));
    return
end
...
for i = 1 : 200
    ...
    [maxsirdbformobile, basestationconnectedto, basestationrxpower] = powerbalance.uplinksir(pathgain, txpowerofmobile);
    ...
    if sirmax - sirmin <= powerbalance.bestpairwisesirtol % 0.05
    ...
    assert(powerbalance.isequalfp(interferencepower, [Imobmin; Imobmax], 1e-12))
