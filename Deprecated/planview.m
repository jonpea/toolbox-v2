classdef planview < matlab.mixin.Copyable
    ...
    properties (Hidden = true, SetAccess = private)
        ...
        % Interactive state
        EditMode = editmode.None % AccessPoint | Mobile | None
        EditIndex = 0
        EditMotion = false
    ...
    methods (Access = public)
        ...
        function obj = planview(faces, vertices, accesspoints, mobiles, varargin)
    ...
    methods (Access = private)
        ...
        function refreshDisplayAccessPoints(obj)
            ...
            function refreshdisplay(accesspoint)
                summary = sprintf( ...
                    ...
                    accesspoint.Index, ...
                    accesspoint.Channel);
                if currentmode == editmode.AccessPoint && ...
        ...
        function refreshDisplayMobiles(obj)
            ...
            function refreshdisplay(mobile)
                ...
                if currentmode == editmode.Mobile && ...
    ...
    methods
        ...
        function updateLinks(obj)
            ...
            downlinkgain = fromdb(dlinks.PowerDBW);
    ...
    methods (Access = private)
        ...
        function dsinr = calculateDownlinkSINR(obj, xfield, yfield)
            ...
            downlinkgain = fromdb(links.PowerDBW);
    ...
    methods (Access = private)
        ...
        function windowButtonDown(obj, handle, ~)
            ...
            checkcandidates(obj.AccessPointList, editmode.AccessPoint)
            checkcandidates(obj.MobileList, editmode.Mobile)
        ...
        function windowButtonUp(obj, handle, ~)
            ...
            if isequal(obj.EditMode, editmode.None)
                return
            end
            
            % NB: Before updating edit mode
            refreshcontours = obj.EditMotion && ...
                obj.EditMode == editmode.AccessPoint;
...
for i = 1 : size(xmobile, 1)
    ...
    function gain = friisdb(distance)
        ...
        gain = 2*todb(options.Wavelength, 4*pi*distance);
    end
