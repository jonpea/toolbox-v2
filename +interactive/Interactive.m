classdef Interactive < matlab.mixin.Copyable
    ...
    methods (Access = public)
        ...
        function obj = Interactive(faces, vertices, accesspoints, mobiles, varargin)
            ...
            obj.SinkGain = power.isofunction(options.MobileGains);
            obj.SourceGain = power.isofunction(options.AccessPointGains);
            obj.TransmissionGain = power.isofunction(options.TransmissionGains);
    ...
    methods (Access = private)
        ...
        function dsinr = calculateDownlinkSINR(obj, xfield, yfield)
            ...
            links = power.analyze( ...
                ...
                'SourceGain', obj.SourceGain, ...
                'TransmissionGain', obj.TransmissionGain, ...
                'SinkGain', power.isofunction(0.0), ... % NB: zero on downlinks
                'Reporting', false);
