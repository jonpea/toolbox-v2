...
[faces, vertices, types] = data.engineeringtower8data3d;
...
points.text(ax, facevertex.reduce(@mean, faces, vertices), 'FontSize', 1, 'Color', 'black')
points.text(ax, vertices, 'FontSize', 1, 'Color', 'red')
axis('equal')
...
% sourcegain = antennae.isopattern(10.0);
...
reflectiongains = antennae.dispatch({
    ...
    makepattern('Wall1_TE_refl_1GHz.txt') ...
    makepattern('Wall1_TE_refl_1GHz.txt') ...
    }, ...
    types, ...
...
transmissiongains = antennae.dispatch({
    ...
    makepattern('Wall1_TE_trans_1GHz.txt') ...
    makepattern('Wall1_TE_trans_1GHz.txt') ...
    }, ...
    types, ...
    antennae.orthocontext(scene.Frame, @specfun.cart2uqsphi));
