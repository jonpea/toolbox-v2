...
if istable(table)
    table = table2struct(table);
end

assert(istabular(table))
...
[candidates, indices] = setdiff(fieldnames(table), patchfieldnames);
