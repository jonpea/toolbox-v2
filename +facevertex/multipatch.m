...
if ispolygon
    error( ...
        contracts.msgid(mfilename, 'PolygonsUnsupported'), ...
...
if numel(labels) ~= size(scene.Faces, 1)
    error( ...
        contracts.msgid(mfilename, 'SceneLabelMismatch'), ...
...
if isempty(candidates)
    error( ...
        contracts.msgid(mfilename, 'NoRefField'), ...
...
if ~isa(table.(keyname), class(labels))
    error( ...
        contracts.msgid(mfilename, 'LabelTypeMismatch'), ...
...
elseif isnumeric(labels)
    ...
    error( ...
        contracts.msgid(mfilename, 'UnsupportedLabels'), ...
